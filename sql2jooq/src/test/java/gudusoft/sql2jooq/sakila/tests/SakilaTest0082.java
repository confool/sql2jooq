...
public class SakilaTest0082 extends SakilaTest
{
...
Result<Record1<String>> result = create.select( DSL.substring( DSL.inline( String.valueOf( "foobarbar" ) ), DSL.inline( 4 ) ) ).fetch( );
