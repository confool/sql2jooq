...
public class SakilaTest0092 extends SakilaTest
{
...
Result<Record1<String>> result = create.select( MySQLDSL.sha2( DSL.inline( String.valueOf( "abc" ) ), DSL.inline( 1024 ) ) ).fetch( );
