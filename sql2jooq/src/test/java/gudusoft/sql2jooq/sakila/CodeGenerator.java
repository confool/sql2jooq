...
public class CodeGenerator
{
    ...
    public static void main( String[] args ) throws IOException
    {
        ...
        String[] queries = FileUtil
                .read(new File("./src/test/java/gudusoft/sql2jooq/sakila/queries.txt"))
                .split(";\\s+");
        ...
        for (final String query : queries)
        {
            ...
            try {
                ...
                File dir = new File("./src/test/java/gudusoft/sql2jooq/sakila/tests");
                dir.mkdirs();
                File templateFile = new File( "./src/test/resources/templates/SakilaTest.template.java" );
                File saveFile = new File(dir, "/SakilaTest" + id + ".java" );
