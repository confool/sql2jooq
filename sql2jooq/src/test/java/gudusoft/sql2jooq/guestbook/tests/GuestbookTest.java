...
Result<Record4<Long, String, String, String>> result = create.select( b.ID, a.TITLE, a.BODY, b.ADDRESS )
	.from( a, b )
	.where( a.BODY.equal( DSL.inline( String.valueOf( "Hello World" ) ) ).and( a.TIMESTAMP.equal( DSL.inline( String.valueOf( "2003-10-01 00:24:08" ) ) ) ).and( a.ID.equal( DSL.inline( Long.valueOf( 1 ) ) ) ) )
	.groupBy( a.BODY, a.ID )
