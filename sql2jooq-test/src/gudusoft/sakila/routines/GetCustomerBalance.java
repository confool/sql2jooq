...
public class GetCustomerBalance extends org.jooq.impl.AbstractRoutine<java.math.BigDecimal> {
	...
	private static final long serialVersionUID = 1059940537;
	...
	public GetCustomerBalance() {
		super("get_customer_balance", gudusoft.sakila.Sakila.SAKILA, org.jooq.impl.SQLDataType.DECIMAL.precision(5, 2));
	...
	public void setPCustomerId(java.lang.Integer value) {
		setValue(gudusoft.sakila.routines.GetCustomerBalance.P_CUSTOMER_ID, value);
	}
	...
	public void setPEffectiveDate(java.sql.Timestamp value) {
		setValue(gudusoft.sakila.routines.GetCustomerBalance.P_EFFECTIVE_DATE, value);
	}
