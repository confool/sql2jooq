...
public class RewardsReport extends org.jooq.impl.AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = 1356597918;
	...
	public RewardsReport() {
		super("rewards_report", gudusoft.sakila.Sakila.SAKILA);
	...
	public void setMinMonthlyPurchases(java.lang.Byte value) {
		setValue(gudusoft.sakila.routines.RewardsReport.MIN_MONTHLY_PURCHASES, value);
	}
	...
	public void setMinDollarAmountPurchased(java.math.BigDecimal value) {
		setValue(gudusoft.sakila.routines.RewardsReport.MIN_DOLLAR_AMOUNT_PURCHASED, value);
	}
